...
import db.ConsultasVisualizarPedidos;
...
public class VentanaVisualiazarPedidos extends JFrame {
	...
	public VentanaVisualiazarPedidos(String usuario, ArrayList<PedidoServicios> listaServiciosPedidos, Locale locale) {
		...
		botonBorrar.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				int confirmacion = JOptionPane.showConfirmDialog(null, sSeguro, sConfi, JOptionPane.YES_NO_OPTION);
		...
		botonGuardar.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (confirmacion == JOptionPane.YES_OPTION) {
					...
					ConsultasVisualizarPedidos.guardarLaLista(list);
				}
	...
	private static void borrarDeLaLista(ArrayList<PedidoServicios> listaServiciosPedidos) {
		...
		if (fila == -1) {
			JOptionPane.showMessageDialog(null, sPrimeroDebesFila, sErrorEnSeleccion, JOptionPane.ERROR_MESSAGE);
		} else {
