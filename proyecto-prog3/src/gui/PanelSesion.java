...
public class PanelSesion extends JPanel {
	...
	public PanelSesion(JFrame ventanaGrafica) {
		...
		JLabel tSesion = new JLabel(String.format("Ultimo inicio de sesión: %s",
				DeustoTaller.getSesion().gethUltimaSesion().format(DateTimeFormatter.ofLocalizedDateTime(FormatStyle.MEDIUM))));
