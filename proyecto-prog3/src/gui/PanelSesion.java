...
public class PanelSesion extends JPanel {
    ...
    public PanelSesion(JFrame ventanaGrafica) {
        ...
        String ultimaSesionTexto = usuario.gethUltimaSesion().format(DateTimeFormatter.ofLocalizedDateTime(FormatStyle.MEDIUM));
        ...
        if (vehiculos.isEmpty()) {
            ...
            for (Vehiculo vehiculo : vehiculos) {
                JLabel infoVehiculo = new JLabel("- " + vehiculo.getModelo() + " (" + vehiculo.getMarca() + ", " + vehiculo.getMatricula() + ")");
